...
if(tomato_slam_CONFIG_INCLUDED)
  return()
endif()
set(tomato_slam_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(tomato_slam_SOURCE_PREFIX /home/yw/tomato_slam_ws/src/tomato_slam)
  set(tomato_slam_DEVEL_PREFIX /home/yw/tomato_slam_ws/devel)
  set(tomato_slam_INSTALL_PREFIX "")
  set(tomato_slam_PREFIX ${tomato_slam_DEVEL_PREFIX})
else()
  set(tomato_slam_SOURCE_PREFIX "")
  set(tomato_slam_DEVEL_PREFIX "")
  set(tomato_slam_INSTALL_PREFIX /home/yw/tomato_slam_ws/install)
  set(tomato_slam_PREFIX ${tomato_slam_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'tomato_slam' is deprecated")
...
set(tomato_slam_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/home/yw/tomato_slam_ws/devel/include;/home/yw/tomato_slam_ws/src/tomato_slam/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl;/usr/local/include/opencv4;/usr/local/eigen3.4.0/include/eigen3;/usr/local/cuda-11.7/include " STREQUAL " ")
  set(tomato_slam_INCLUDE_DIRS "")
  set(_include_dirs "/home/yw/tomato_slam_ws/devel/include;/home/yw/tomato_slam_ws/src/tomato_slam/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl;/usr/local/include/opencv4;/usr/local/eigen3.4.0/include/eigen3;/usr/local/cuda-11.7/include")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND tomato_slam_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yw/tomato_slam_ws/devel/lib;/home/yw/tomato_slam_ws/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(tomato_slam_LIBRARY_DIRS ${lib_path})
      list(APPEND tomato_slam_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'tomato_slam'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND tomato_slam_LIBRARIES ${lib})
    endif()
  endif()
...
set(tomato_slam_EXPORTED_TARGETS "tomato_slam_generate_messages_cpp;tomato_slam_generate_messages_eus;tomato_slam_generate_messages_lisp;tomato_slam_generate_messages_nodejs;tomato_slam_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${tomato_slam_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;std_msgs;sensor_msgs;geometry_msgs;visualization_msgs;pcl_ros;cv_bridge;image_transport;tf2;tf2_ros;message_runtime")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 tomato_slam_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${tomato_slam_dep}_FOUND)
      find_package(${tomato_slam_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${tomato_slam_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(tomato_slam_INCLUDE_DIRS ${${tomato_slam_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(tomato_slam_LIBRARIES ${tomato_slam_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${tomato_slam_dep}_LIBRARIES})
  _list_append_deduplicate(tomato_slam_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(tomato_slam_LIBRARIES ${tomato_slam_LIBRARIES})

  _list_append_unique(tomato_slam_LIBRARY_DIRS ${${tomato_slam_dep}_LIBRARY_DIRS})
  list(APPEND tomato_slam_EXPORTED_TARGETS ${${tomato_slam_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "tomato_slam-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${tomato_slam_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
